...
const features = [
  ...
  { icon: Leaf, title: "Sanctuary", desc: "Mental reset tools for the trading mind.", color: "#4BA3D4" },
  { icon: Zap, title: "Position Calculator", desc: "Risk-based sizing, auto-calculated.", color: "#22C55E" },
  { icon: Calendar, title: "News Calendar", desc: "Never trade into a high-impact event again.", color: "#D9CA82" },
  { icon: FlaskConical, title: "Backtesting", desc: "Test your edge on 10+ years of real data.", color: "#03588C" },
  { icon: Play, title: "Trade Replay", desc: "Relive your real trades second by second.", color: "#4BA3D4" },
  { icon: Code2, title: "Custom Indicators", desc: "Build your own indicators with no-code or full code.", color: "#22C55E" },
...
const pricing = [
  {
    name: "Starter", price: { monthly: 0, yearly: 0 },
  ...
  },
  {
    ...
    features: ["3 broker connections", "Automated journal", "Full analytics (50+ reports)", "KlarAI coach", "Sanctuary", "Backtesting", "Trade Replay", "Custom indicators (5)", "Priority support"],
    cta: "Start Pro Free", highlight: true,
  },
  {
    name: "Elite", price: { monthly: 69, yearly: 57 },
    ...
    cta: "Start Elite Free", highlight: false,
  },
];
      ...
      <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-5xl">
        <div className="glass rounded-2xl px-5 py-3 flex items-center justify-between shadow-card">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-[#03588C] flex items-center justify-center shadow-glow-xs">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link href="/register" className="bg-[#03588C] text-white text-sm px-4 py-2 rounded-xl hover:bg-[#024a77] transition-all shadow-glow-xs">Start Free</Link>
          </div>
        ...
        <AnimatePresence>
          {navOpen && (
            ...
            >
              ...
              <Link href="/register" className="bg-[#03588C] text-white text-sm px-4 py-2 rounded-xl text-center">Start Free</Link>
            </motion.div>
          )}
        </AnimatePresence>
      </nav>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((f, i) => (
              ...
              >
                <div className="w-9 h-9 rounded-xl flex items-center justify-center mb-3" style={{ backgroundColor: `${f.color}18` }}>
      ...
      <section className="py-32 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-[#6B7280] text-lg mb-10">Join 12,400+ traders already using KlarTrade.</p>
            <Link href="/register">
              <motion.button
      ...
      <footer className="border-t border-white/[0.05] py-10 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-[#03588C] flex items-center justify-center">
              <TrendingUp className="w-3.5 h-3.5 text-white" strokeWidth={2.5} />
            </div>
            <span className="text-[14px] font-bold tracking-tight">Klar<span className="text-[#4BA3D4]">Trade</span></span>
          </div>
          <div className="flex items-center gap-6 text-sm text-[#6B7280]">
            {["Terms", "Privacy", "Risk Policy", "Support"].map((l) => (
              <a key={l} href="#" className="hover:text-[#F2F0EB] transition-colors">{l}</a>
            ))}
          </div>
          <p className="text-sm text-[#6B7280]">© 2024 KlarTrade. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
